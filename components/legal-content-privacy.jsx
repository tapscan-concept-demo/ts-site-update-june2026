// Privacy Policy content — sourced 1:1 from
// /Page-1/Privacy/index.jsx in the attached Figma.
// Split from legal-content.jsx because of its size.

const LP_PRIVACY = [
  // Top: "Ahead of the Curve Group Privacy Policy" + intro paragraphs
  { lvl: 1, h: "Ahead of the Curve Group Privacy Policy", p: [
    "Your privacy is important to us. It is Ahead of the Curve Group's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://tapscan.info, and other sites we own and operate.",
  ...
  // Information We Collect (Frame39724 called 4 times)
  { lvl: 2, h: "Information We Collect", p: [
  ...
  { lvl: 3, h: "Device Data", p: [
    "When you visit our website or interact with our services, we may automatically collect data about your device, such as:",
    "Device Type\nOperating system\nGeo-location data",
    "Data we collect can depend on the individual settings of your device and software. We recommend checking the policies of your device manufacturer or software provider to learn what information they make available to us.",
  ] },
  { lvl: 3, h: "Security of Your Personal Information", p: [
  ...
  { lvl: 2, h: "How Long We Keep Your Personal Information", p: [
  ...
  { lvl: 2, h: "Children\u2019s Privacy", p: [
    "We do not aim any of our products or services directly at children under the age of 13 and we do not knowingly collect personal information about children under 13.",
  ] },

  { lvl: 2, h: "Disclosure of Personal Information to Third Parties", p: [
  ...
  { lvl: 2, h: "International Transfers of Personal Information", p: [
    "The personal information we collect is stored and/or processed in Canada, Ireland, United States of America (the) , or where we or our partners, affiliates, and third-party providers maintain facilities.",
    "The countries to which we store, process, or transfer your personal information may not have the same data protection laws as the country in which you initially provided the information. If we transfer your personal information to third parties in other countries: (i) we will perform those transfers in accordance with the requirements of applicable law; and (ii) we will protect the transferred personal information in accordance with this privacy policy.",
  ] },

  { lvl: 2, h: "Your Rights and Controlling Your Personal Information", p: [
  ...
  { lvl: 2, h: "California Privacy Laws (CCPA)", p: [
  ...
  { lvl: 2, h: "California Notice of Collection", p: [
  ...
  { lvl: 2, h: "Right to Know and Delete", p: [
  ...
  // GDPR
  { lvl: 2, h: "Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)", p: [] },
  { lvl: 3, h: "Data Controller / Data Processor", p: [
    "The GDPR distinguishes between organizations that process personal information for their own purposes (known as \"data controllers\") and organizations that process personal information on behalf of other organizations (known as \"data processors\"). We, Ahead of the Curve Group, located at the address provided in our Contact Us section, are a Data Controller and/or Processor with respect to the personal information you provide to us.",
  ] },
  { lvl: 3, h: "Legal Bases for Processing Your Personal Information", p: [
    "We will only collect and use your personal information when we have a legal right to do so. In which case, we will collect and use your personal information lawfully, fairly, and in a transparent manner. If we seek your consent to process your personal information, and you are under 16 years of age, we will seek your parent or legal guardian\u2019s consent to process your personal information for that specific purpose.",
    "Our lawful bases depend on the services you use and how you use them. This means we only collect and use your information on the following grounds:",
  ] },
  { lvl: 3, h: "Our Legitimate Interests", p: [
    "Where we assess it is necessary for our legitimate interests, such as for us to provide, operate, improve and communicate our services. We consider our legitimate interests to include research and development, understanding our audience, marketing and promoting our services, measures taken to operate our services efficiently, marketing analysis, and measures taken to protect our legal rights and interests.",
  ] },
  { lvl: 3, h: "Compliance With the Law", p: [
    "In some cases, we may have a legal obligation to use or keep your personal information. Such cases may include (but are not limited to) court orders, criminal investigations, government requests, and regulatory obligations. If you have any further enquiries about how we retain personal information in order to comply with the law, please feel free to enquire using the details provided in the Contact Us section of this privacy policy.",
  ] },
  { lvl: 3, h: "International Transfers Outside of the European Economic Area (EEA)", p: [
    "We will ensure that any transfer of personal information from countries in the European Economic Area (EEA) to countries outside the EEA will be protected by appropriate safeguards, for example by using standard data protection clauses approved by the European Commission, or the use of binding corporate rules or other legally accepted means.",
  ] },
  { lvl: 3, h: "Your Rights and Controlling Your Personal Information", p: [
  ...
  { lvl: 2, h: "Additional Disclosures for Australian Privacy Act Compliance (AU)", p: [] },
  { lvl: 3, h: "International Transfers of Personal Information", p: [
    "Where the disclosure of your personal information is solely subject to Australian privacy laws, you acknowledge that some third parties may not be regulated by the Privacy Act and the Australian Privacy Principles in the Privacy Act. You acknowledge that if any such third party engages in any act or practice that contravenes the Australian Privacy Principles, it would not be accountable under the Privacy Act, and you will not be able to seek redress under the Privacy Act.",
  ] },

  // PIPEDA
  { lvl: 2, h: "Additional Disclosures for Personal Information Protection and Electronic Documents Act (PIPEDA) Compliance (Canada)", p: [] },
  { lvl: 3, h: "Additional Scope of Personal Information Under PIPEDA", p: [
    ...
    "As PIPEDA refers to personal information using the term Personally Identifying Information (PII), any references to personal information and PII in this privacy policy, and in official communications from Ahead of the Curve Group, are intended as equivalent to one another in every way, shape and form.",
  ] },
  { lvl: 3, h: "Valid Consent", p: [
  ...
  { lvl: 3, h: "Right to Withdraw Consent", p: [
  ...
  { lvl: 3, h: "Right of Access Under PIPEDA", p: [
  ...
  { lvl: 3, h: "Right of Rectification Under PIPEDA", p: [
  ...
  { lvl: 3, h: "Enquiries, Reports, and Escalation", p: [
    "To enquire about Ahead of the Curve Group's privacy policy, or to report violations of user privacy, you may contact us using the details in the Contact us section of this privacy policy.",
    ...
    "30 Victoria Street Gatineau, QC K1A 1H3 Toll Free: 1.800.282.1376 www.priv.gc.ca",
  ] },

  // UK GDPR
  { lvl: 2, h: "Additional Disclosures for UK General Data Protection Regulation (UK GDPR) Compliance (UK)", p: [] },
  { lvl: 3, h: "Data Controller / Data Processor", p: [
    "The GDPR distinguishes between organizations that process personal information for their own purposes (known as \"data controllers\") and organizations that process personal information on behalf of other organizations (known as \"data processors\"). We, Ahead of the Curve Group, located at the address provided in our Contact Us section, are a Data Controller and/or Processor with respect to the personal information you provide to us.",
  ] },
  { lvl: 3, h: "Third-Party Provided Content", p: [
  ...
  { lvl: 3, h: "Additional Disclosure for Collection and Use of Personal Information", p: [
  ...
  { lvl: 3, h: "Personal Information No Longer Required for Our Purposes", p: [
  ...
  { lvl: 3, h: "Consent From You", p: [
    "Where you give us consent to collect and use your personal information for a specific purpose. You may withdraw your consent at any time using the facilities we provide; however this will not affect any use of your information that has already taken place. When you contact us, we assume your consent based on your positive action of contact, therefore you consent to your name and email address being used so we can respond to your enquiry.",
    "Where you agree to receive marketing communications from us, we will do so based solely on your indication of consent or until you instruct us not to, which you can do at any time.",
    "While you may request that we delete your contact details at any time, we cannot recall any email we have already sent. If you have any further enquiries about how to withdraw your consent, please feel free to enquire using the details provided in the Contact Us section of this privacy policy.",
  ] },
  { lvl: 3, h: "Performance of a Contract or Transaction", p: [
  ...
  { lvl: 3, h: "Your Data Subject Rights", p: [
    ...
    "only applies to personal data which a person has directly given to Ahead of the Curve Group in electronic form; and\nonward transfer will only be available where this is \"technically feasible\".",
  ...
  { lvl: 3, h: "Enquiries, Reports, and Escalation", p: [
    "To enquire about Ahead of the Curve Group's privacy policy, or to report violations of user privacy, you may contact our Data Protection Officer using the details in the Contact us section of this privacy policy.",
